...
def main():
  ...
  print("Daily precipitation accumulation has been saved to 'beirut-daily-precipitation-1hr.csv'.")
  ...
  monthly_precip.to_csv("./data/beirut-monthly-precipitation-1hr.csv", index=False)
